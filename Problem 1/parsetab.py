...
_lr_productions = [
  ...
  ('exp -> atom','exp',1,'p_exp_atom','yacc.py',183),
  ('exp -> quoted_list','exp',1,'p_exp_qlist','yacc.py',187),
  ('exp -> call','exp',1,'p_exp_call','yacc.py',191),
  ('quoted_list -> QUOTE list','quoted_list',2,'p_quoted_list','yacc.py',195),
  ('list -> LPAREN items RPAREN','list',3,'p_list','yacc.py',199),
  ('items -> item items','items',2,'p_items','yacc.py',203),
  ('items -> empty','items',1,'p_items_empty','yacc.py',207),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',211),
  ('item -> atom','item',1,'p_item_atom','yacc.py',215),
  ('item -> quoted_list','item',1,'p_item_list','yacc.py',223),
  ('item -> call','item',1,'p_item_call','yacc.py',227),
  ('item -> empty','item',1,'p_item_empty','yacc.py',231),
  ('call -> LPAREN SIMB items RPAREN','call',4,'p_call','yacc.py',235),
  ('atom -> SIMB','atom',1,'p_atom_simbol','yacc.py',240),
