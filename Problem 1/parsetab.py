...
_lr_productions = [
  ...
  ('exp -> atom','exp',1,'p_exp_atom','yacc.py',152),
  ('exp -> quoted_list','exp',1,'p_exp_qlist','yacc.py',156),
  ('exp -> call','exp',1,'p_exp_call','yacc.py',160),
  ('quoted_list -> QUOTE list','quoted_list',2,'p_quoted_list','yacc.py',164),
  ...
  ('call -> LPAREN SIMB items RPAREN','call',4,'p_call','yacc.py',204),
  ('atom -> SIMB','atom',1,'p_atom_simbol','yacc.py',210),
  ('atom -> bool','atom',1,'p_atom_bool','yacc.py',214),
  ('atom -> NUM','atom',1,'p_atom_num','yacc.py',218),
  ('atom -> TEXT','atom',1,'p_atom_word','yacc.py',222),
  ('atom -> <empty>','atom',0,'p_atom_empty','yacc.py',226),
  ('bool -> TRUE','bool',1,'p_true','yacc.py',230),
  ('bool -> FALSE','bool',1,'p_false','yacc.py',234),
  ('atom -> NIL','atom',1,'p_nil','yacc.py',238),
]
